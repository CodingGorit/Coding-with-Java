...
<div class="container ">
    <div class="row row-centered">
        ...
        <div class="well col-md-6 col-centered">
            <form action="updateServlet?addStuId=<%=StuId%>" method="post" role="form">
                <div class="form-group">
                    <label for="user_id" class="col-sm-3 control-label">用户ID</label>
                    <div class="col-sm-9">
                        <input type="text" disabled class="form-control" id="user_id" name="addStuId" value="<%=StuId%>"
                               placeholder="请输入学生学号">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" style="display: flex">
                        <button type="submit" class="btn btn-primary"  id="btn_submit_addStu" onclick="window.location.reload();">
                            提交
                        </button>
                        &nbsp;
